    ...
    <div className="flex flex-col items-center py-4">
              ...
              <div key={lesson.id} className="flex flex-col items-center">
                ...
                >
                  <div
                    className={`
                      ...
                      ${state === 'completed'
                        ...
                        : state === 'current'
                          ? 'w-14 h-14 bg-navy-900 border-3 border-chess-gold shadow-lg shadow-chess-gold/30 hover:shadow-chess-gold/50'
                  ...
                  >
                    ...
                    {state === 'current' && (
                      <span className="text-chess-gold font-bold text-sm">{lesson.id + 1}</span>
                    )}
                    {state === 'upcoming' && (
                    ...
                    {state === 'current' && (
                      <span className="absolute inset-0 rounded-full border-2 border-chess-gold animate-ping opacity-20" />
                    )}
                  </div>
      ...
      <div
        className={`
          ...
          ${allComplete
            ? 'bg-chess-gold/20 border-2 border-chess-gold shadow-lg shadow-chess-gold/30'
      ...
      <span className={`text-xs mt-2 font-medium ${allComplete ? 'text-chess-gold' : 'text-gray-500'}`}>
